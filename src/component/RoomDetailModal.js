       ...
       <Modal isOpen={isOpen}  onRequestClose={onRequestClose}  style={customStyles}  contentLabel="Room Details">
        <div className='room_detail'>
           <div className="title_top">
                <img src={`${process.env.PUBLIC_URL}/images/part${roomData.img_n}.png`} alt={roomData.part} />
               ...
               <ul>
                   {roomData.doctors.map((doctor,index)=>(
                       ...
                       <div className="doctor_detail">
                           <img src={`${process.env.PUBLIC_URL}/images/doc_img/${doctor.doc_img}.jpg`} alt="" />
                           <div>
                       ...
                       <img src={`${process.env.PUBLIC_URL}/images/doctor_time.png`} alt="" className='doctor_time' /> 
                       </li>
                   ))}
               </ul>
             ) : (
